...
This commands save buffer first.
...
(define-abbrev-table 'xah-js-mode-abbrev-table
  '(
    ...
    ("exec" "exec(\"str▮\")" xah-js--abbrev-hook-f)
    ...
    ("localeCompare" "localeCompare(▮)" xah-js--abbrev-hook-f)
    ("ma" "matchAll" xah-js--abbrev-hook-f)
    ("map" "map( f▮, ?this )" xah-js--abbrev-hook-f)
    ("match" "match(/▮/g)" xah-js--abbrev-hook-f)
    ("matchAll" "matchAll(\"▮\", ?\"flags\")" xah-js--abbrev-hook-f)
    ...
    ("search" "search(/▮/)" xah-js--abbrev-hook-f)
    ...
    ("test" "test(\"str▮\")" xah-js--abbrev-hook-f)
